...
from experiments.relation_extraction import re_config
...
def test():
    ...
    train_file_path = "../../data/re/relations-test.csv"
    ...
    model.train_model(train_df, eval_df=train_df, macro_f1=macro_f1, macro_r=macro_recall, macro_p=macro_precision, cls_report=classification_report)
