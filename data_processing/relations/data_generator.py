...
def replace_entities(relations_path, entities_path, output_path, n=10):
...
if __name__ == '__main__':
    relations_path = '../../data/re/data_generation/equal.csv'
    entities_path = '../../data/re/data_generation/entities.csv'
    output_path = '../../data/re/data_generation/equal_synthetic.csv'
    replace_entities(relations_path, entities_path, output_path, n=10)
